...
const faqs = [
  ...
  {
    question: 'מה זה סעיף 14 לפנסיה ולמה הוא חשוב?',
    answer:
      'סעיף 14 הוא הסדר שמשחרר את המעסיק מהשלמת פיצויי פיטורים מעבר לסכומים שכבר הופרשו לקרן הפנסיה. כשהוא חל, הכספים שהופרשו בקרן הופכים לפיצויים שלך מהיום הראשון - גם בהתפטרות, וגם אם הוחלפו מקומות עבודה. חשוב לבדוק האם הסעיף קיים בחוזה ומה השפעותיו על הכסף שיגיע לך בסוף.',
  },
  {
  ...
  return (
    <div className="min-h-screen relative" dir="rtl">
      <SEO
        ...
        keywords="שאלות נפוצות, ייעוץ שכר, זכויות עובדים, פיצויי פיטורים, סעיף 14, ימי חופשה, איריס שני"
        url="/faq"
        image="/iris-og.png"
        breadcrumbs={[
          { name: 'דף הבית', url: '/' },
